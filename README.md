...
После `uv run streamlit run app/main.py` откройте http://localhost:8501 и задайте
demo-вопрос. На странице видны: найденные фрагменты с `doc_id` и score, итоговый
ответ и список источников; в sidebar — регулировка top-k, порога релевантности и
кнопки demo-вопросов. Пример вопросов и ответов приведён выше в разделе «Demo-вопросы».
